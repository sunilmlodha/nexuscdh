...
const FLOW_STEPS: FlowStep[] = [
  ...
  {
    id: 'arbitration',
    label: 'NBA Prioritization',
    sublabel: 'Best Action Selection',
    icon: Target,
    color: '#00838f',
    bg: '#e0f7fa',
    page: '/simulator',
    description: 'The prioritization engine ranks all eligible, policy-approved, scored actions and selects the single Next-Best-Action (or ranked list). Prioritization mode is set per strategy.',
    inputs: ['Scored action set', 'Strategy prioritization mode', 'Expected value weights'],
    outputs: ['Ranked action list', 'Winning action + score', 'Prioritization rationale'],
      ...
      <div className="card" style={{ padding: 20, marginTop: 24 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 10 }}>
          {[
            ...
            { icon: Brain, label: 'Self-Learning Models', desc: 'Bayesian propensity scoring', color: '#7b1fa2', page: '/models' },
